...
class StripeInitController {
  public async initCustomerId(
    req: Request<{}, {}, TriggerInsertPayload>,
    res: Response
  ) {
    console.log('in initCustomerId');
...
export const stripeInitController = new StripeInitController();
